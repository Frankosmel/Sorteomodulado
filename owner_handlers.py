from telebot import TeleBot from telebot.types import ReplyKeyboardMarkup, KeyboardButton, ReplyKeyboardRemove, InlineKeyboardMarkup, InlineKeyboardButton from storage import load, save from scheduler import set_group_timezone from config import ADMINS, FILES from draw_handlers import do_draw
...
gid = getattr(bot, 'user_data', {}).get(uid)
    ...
    if text == "🌐 Cambiar zona horaria":
        ...
        prompt_text = (
            ...
            "1️⃣ Envía: `<chat_id>,<Zona IANA>`\n"
            "2️⃣ Ejemplo: `-1001234567890,Europe/Madrid`\n\n"
            "▶ Yo responderé confirmando tu nueva zona."
        )
